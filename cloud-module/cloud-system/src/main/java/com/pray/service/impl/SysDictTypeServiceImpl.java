...
import com.pray.mapper.SysDictDataMapper;
import com.pray.mapper.SysDictTypeMapper;
import com.pray.service.ISysDictTypeService;
import com.pray.utils.DictUtils;
    ...
    public void deleteDictTypeByIds(Long[] dictIds) {
        for (Long dictId : dictIds) {
            ...
            if (dictDataMapper.countDictDataByType(dictType.getDictType()) > 0) {
                throw new CloudException(String.format("%1$s已分配,不能删除", dictType.getDictName()));
            }
