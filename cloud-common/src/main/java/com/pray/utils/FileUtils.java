...
public class FileUtils {
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, RainyConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/春江花朝秋月夜.png -- 春江花朝秋月夜.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/春江花朝秋月夜.png -- 春江花朝秋月夜
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
