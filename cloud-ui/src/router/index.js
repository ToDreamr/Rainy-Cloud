...
export const dynamicRoutes = [
  ...
  // 下面是 project 模块
  {
    path: "/project/my-project/info",
    component: Layout,
    hidden: true,
    permissions: ["project:my-project:info"],
    children: [
      {
        path: "",
        component: () => import("@/views/project/my-project/info"),
        name: "MyProjectInfo",
        meta: { title: "项目详情", activeMenu: "/project/my-project", noCache: true },
      },
    ],
  },
  {
    path: "/project/my-task/info",
    component: Layout,
    hidden: true,
    permissions: ["project:my-task:info"],
    children: [
      {
        path: "",
        component: () => import("@/views/project/my-task/info"),
        name: "MyTaskInfo",
        meta: { title: "任务详情", activeMenu: "/project/my-task", noCache: true },
      },
    ],
  },
  {
    path: "/project/my-task/child/info",
    component: Layout,
    hidden: true,
    permissions: ["project:my-task:info"],
    children: [
      {
        ...
        meta: { title: "子任务详情", activeMenu: "/project/my-task", noCache: true },
      },
    ],
  },
  // 下面是审批流程相关模块
