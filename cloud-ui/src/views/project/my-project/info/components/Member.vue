...
<script>
import AddPeopleDialog from "@/views/project/my-project/components/AddPeopleDialog"
import { getMemberListApi, deleteProjectMemberApi } from "@/api/project/my-project.js"
