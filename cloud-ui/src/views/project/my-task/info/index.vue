...
import {
  ...
  addTaskCommentApi,
  getSubTaskListApi,
} from "@/api/project/my-task.js"
import { getProjectListApi } from "@/api/dashboard/index.js"
import { getStageListApi, getFileListApi, deleteFileApi } from "@/api/project/my-project.js"
...
export default {
  ...
  methods: {
    ...
    clickSubTask(taskId, taskName) {
      this.$router.push({ path: "/project/my-task/child/info", query: { taskId: taskId } })
    },
