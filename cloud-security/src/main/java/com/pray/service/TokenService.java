...
public class TokenService {
    ...
    public AuthUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            try {
                ...
                AuthUser user = redisService.getCacheObject(userKey);
                return user;
            } catch (Exception e) {
            }
        }
    ...
    public AuthUser getLoginUser(String token)
    {
        ...
        try
        {
            if (StringUtils.isNotEmpty(token))
            {
                ...
                user = jsonObject.toJavaObject(AuthUser.class);
                return user;
            }
        }
        catch (Exception e)
     ...
     * @param loginUser 登录信息
     */
    public void refreshLongToken(AuthUser loginUser) {
        loginUser.setLoginTime(System.currentTimeMillis());
     ...
     * @param loginUser 登录信息
     */
    public void updateToken(AuthUser loginUser) {
